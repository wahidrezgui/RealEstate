...
namespace CleanArchitecture.Infrastructure.Migrations
{
    ...
    [Migration("20220331102953_add-notaire1")]
    partial class addnotaire1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Commodity", b =>
                {
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Municipalite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Notaire", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.PhotoNotaire", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<byte[]>("ImageInListContent")
                        .HasColumnType("varbinary(max)");
                    ...
                    b.ToTable("PhotosNotaire");
                });

            modelBuilder.Entity("CleanArchitecture.Domain.Entities.PhotoProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PhotosProperty");
                });

            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Propriete", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Commodity", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Entities.Propriete", null)
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Notaire", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Entities.Municipalite", "Municipalite")
                        .WithMany()
                        .HasForeignKey("MunicipaliteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CleanArchitecture.Domain.Entities.PhotoNotaire", "Photo")
                        .WithOne("Notaire")
                        .HasForeignKey("CleanArchitecture.Domain.Entities.Notaire", "PhotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("CleanArchitecture.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                            b1.Property<int>("NotaireId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.PhotoProperty", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Entities.Propriete", "Propriete")
                        .WithMany("Photos")
                        .HasForeignKey("ProprieteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.OwnsOne("CleanArchitecture.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                            ...
                            b1.HasKey("ProprieteId");

                            b1.ToTable("Proprietes");
